<script type="text/javascript">
	...
	function viewData(){
		...
		$.post("showChartOfAccountsList", function(data){
	...
	function funSearchChartOfAccounts(){
		
		
		
		$.post("showChartOfAccountsById", {coaId: $("#coaSearch").val()}, function(data){
...
/**	function funGetCountryName(vCountryId){
	...
	**/  // End funGetAppraisalHeadName()
	...
	function funDelete(pId){
		...
		$.post("deleteChartOfAccounts",{id:pId},function(data){
...
<div class="bootstrap-iso">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-6">
			<fieldset>
				<legend class="h4" style="margin:30px 0 20px 0;" id="selectedChartOfAccountsTitle">Chart Of Accounts</legend>
			...
			<div class="row alert alert-info" style="margin:20px 0 20px 0;">
				...
				<div class="col-lg-8">
					<div class="input-group">
				      	<input type="text" id="coaSearch" class="form-control" placeholder="Enter Chart Of Accounts Id">
				      	<span class="input-group-btn">
				        	<button class="btn btn-info" type="button" onclick="funSearchChartOfAccounts()">Go!</button>
				      	</span>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-6">
			<form id="frmChartOfAccounts" class="well">
				<fieldset>
					...
					<!-- Text input-->
					<div class="form-group">
						<label class="control-label requiredField" for="account_name">Account Name</label>
						<div class="form-group">
							<input id="account_name" name="account_name"
								placeholder="Enter Account Name" class="form-control" type="text" />
							
						</div>
					</div>
					
					<div class="form-group">
						<label class="control-label requiredField" for="name">Account Type</label>
						<div class="form-group">
							  <select>
				...
				<div class="form-group">
						<label class="control-label requiredField" for="opening_balance">Opening Balance</label>
						<div class="form-group">
							<input id="opening_balance" name="opening_balance"
								placeholder="Enter Opening Balance" class="form-control" type="text" />
					...
					<div class="form-group">
						...
						<div class="form-group">
							<input id="description" name="description"
								placeholder="Enter Description" class="form-control" type="text" />
